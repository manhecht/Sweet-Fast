    ...
    <form id="form1" class="loginSeite" runat="server">
        ...
        <div id="divLogin">
            ...
            <asp:RegularExpressionValidator ID="revEmailLogin" runat="server" ControlToValidate="txtEmailLogin" Display="Dynamic" ErrorMessage="Email inkorrekt" ForeColor="#EF476F" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Font-Size="X-Large"></asp:RegularExpressionValidator>
                <br />
            <asp:TextBox ID="txtPasswortLogin" runat="server" placeholder="Passwort" Height="50px" Width="800px" BorderColor="#5C5D67" BorderStyle="Solid" BorderWidth="3px" Font-Size="X-Large" ForeColor="#EF476F" style="margin-top: 0px"></asp:TextBox>
        ...
        <div id="divRegister">
            ...
            <asp:TextBox ID="txtPasswortRegister" runat="server" placeholder="Passwort" Font-Italic="False" Font-Names="Arial" BorderColor="#5C5D67" BorderStyle="Solid" BorderWidth="3px" Font-Size="X-Large" ForeColor="#EF476F" Height="50px" style="margin-bottom: 15px" Width="375px"></asp:TextBox>
